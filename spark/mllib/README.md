...
$ $SPARK_HOME/bin/spark-submit \
    --class "io.aos.spark.mllib.pca.Pca" \
    --master yarn-client \
    --driver-memory 4g \
    --executor-memory 2g \
    --executor-cores 4 \
...
```
scala> val points = spark.textFile("hdfs://dataset/donut/donut.csv").map(parsePoint).cache()
...
$AOS_REPO/algorithm/logistic-regression/data/donut/donut-test.csv is the test
set.

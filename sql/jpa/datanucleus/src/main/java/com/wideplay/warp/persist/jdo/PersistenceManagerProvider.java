 ...
 */
class PersistenceManagerProvider implements Provider<PersistenceManager> {
  private final InternalWorkManager<PersistenceManager> internalWorkManager;

  public PersistenceManagerProvider(InternalWorkManager<PersistenceManager> internalWorkManager) {

...
/**
 * <p>
 * Simple class that launches a HBase Master Server.
 * 
 ...
 *   -Dhbase.log.file=hbase-eric-master-eric.log 
 ...
 * 
 */
public class HBaseMasterServerLauncher {
    private static final Logger LOGGER = LoggerFactory.getLogger(HBaseMasterServerLauncher.class);

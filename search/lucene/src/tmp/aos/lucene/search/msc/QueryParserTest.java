...
public class QueryParserTest extends TestCase {
  ...
  public void testTermRangeQuery() throws Exception {
    Query query = new QueryParser(Version.LUCENE_46,                        //A
    ...
    query = new QueryParser(Version.LUCENE_46, "subject", analyzer)  //B
  ...
  */
  ...
  public void testPhraseQuery() throws Exception {
    ...
    q = new QueryParser(Version.LUCENE_46,
  ...
  public void testSlop() throws Exception {
    ...
    QueryParser qp = new QueryParser(Version.LUCENE_46,
                                     "field", analyzer);
    qp.setPhraseSlop(5);
